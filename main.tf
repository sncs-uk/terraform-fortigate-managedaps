...
resource "fortios_wirelesscontroller_wtp" "ap" {
  ...
  dynamic "radio_1" {
    for_each = { for a in length(try(each.value.radios[1], [])) == 0 ? [] : ["1"] : a => a }
    content {
  ...
  dynamic "radio_2" {
    for_each = { for a in length(try(each.value.radios[2], [])) == 0 ? [] : ["1"] : a => a }
    content {
  ...
  dynamic "radio_3" {
    for_each = { for a in length(try(each.value.radios[3], [])) == 0 ? [] : ["1"] : a => a }
    content {
  ...
  dynamic "radio_4" {
    for_each = { for a in length(try(each.value.radios[4], [])) == 0 ? [] : ["1"] : a => a }
    content {
